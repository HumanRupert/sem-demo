  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <MetricsCard
          title="Total Revenue"
          value={<AnimatedCurrency value={metrics?.total_revenue || 0} />}
        ...
        <MetricsCard
          ...
          value={<AnimatedNumber value={metrics?.total_checkouts || 0} />}
        ...
        <MetricsCard
          ...
          value={<AnimatedPercent value={metrics?.completion_rate || 0} />}
        ...
        <MetricsCard
          title="Dispute Rate"
          value={<AnimatedPercent value={metrics?.dispute_rate || 0} />}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <MetricsCard
          ...
          value={<><AnimatedNumber value={metrics?.trusted_agents || 0} /> / {metrics?.total_agents || 0}</>}
          subtitle={`${metrics?.blocked_agents || 0} blocked`}
          icon={<Bot className="w-5 h-5 text-gray-600" />}
        />
        <MetricsCard
          title="Known Customers"
          value={<AnimatedPercent value={metrics?.known_customer_rate || 0} />}
          subtitle="Consumer recognition rate"
          icon={<Users className="w-5 h-5 text-gray-600" />}
        />
        <MetricsCard
          title="Challenge Rate"
          value={<AnimatedPercent value={metrics?.challenge_rate || 0} />}
